...
;(function ( $, window, document, undefined ) {
    ...
    $.extend(Plugin.prototype, {
        ...
        init: function () {
            ...
            if (this.settings.logLength) console.log('generated bookmarklet: ' + href.length);
        ...
        iframeBookmarklet: function(type, minified, iframeDeltaUrl){
            return "javascript:try{" +
                this.trace('start') +
