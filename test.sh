...
nodejs src/backend.js -r http://127.0.0.1/tutorial --serve-http ./ --browser phantomjs --timeout=300  http://127.0.0.1/dist/ && \
nodejs src/backend.js -r http://127.0.0.1/testsuite/multidomain --serve-http ./ -b phantomjs --timeout=300 http://127.0.0.1/dist/ && \
echo ok
